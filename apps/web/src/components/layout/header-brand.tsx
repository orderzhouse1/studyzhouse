...
export const HEADER_ROOT_CLASS =
  "fixed inset-x-0 top-0 z-50 border-b border-border/90 bg-card/95 shadow-[0_8px_24px_-18px_hsl(222_47%_10%_/_0.2)] backdrop-blur-md md:sticky md:inset-x-auto";

/** ارتفاع شريط الهيدر على الجوال (بدون بحث) — للمسافة تحت الهيدر الثابت */
export const HEADER_MOBILE_SPACER_CLASS = "h-[3.75rem] shrink-0 md:hidden";
